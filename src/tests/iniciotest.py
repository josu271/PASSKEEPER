...
# Imagen
img = PhotoImage(file='../../Recursos/img/avatar-femenino.png')
...
# Título con color morado
heading = Label(frame, text='Iniciar Sesión', fg='#8A2BE2', bg='#fff', font=('Microsoft YaHei UI Light', 23, 'bold'))
...
# Botón para iniciar sesión en color morado
Button(frame, width=39, pady=7, text='Ingresar', bg='#8A2BE2', fg='#fff', border=0, command=verificar_usuario).place(x=35, y=204)

# Recuperar contraseña
label = Label(frame, text="¿Olvidaste tu contraseña?", fg='black', bg='#fff', font=('Microsoft YaHei UI Light', 9))
label.place(x=70, y=270)
sign = Button(frame, width=8, text="Recuperar", border=0, bg='#fff', cursor='hand2', fg='#8A2BE2', command=app_manager.abrir_reestablecer)
...
registro = Button(frame, width=8, text="Registrate", border=0, bg='#fff', cursor='hand2', fg='#8A2BE2', command=app_manager.abrir_registro)
